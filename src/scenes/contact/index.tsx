...
const ContactUs = ({ setSelectedPage }: Props) => {
  const inputStyles = `bg-lighter mb-5 w-full rounded-lg bg-mint px-5 py-3 placeholder-gunmetal text-gunmetal`;
  ...
  return (
    <section id="contacts" className="mx-auto w-5/6 pt-24 pb-32">
      ...
      >
        ...
        >
          <HText>
            <span className="text-mint">CONTACT</span> <span className="text-gunmetal">ME</span>
          </HText>
          <p className="my-5">
        ...
        <div className="mt-10 justify-between gap-8 md:flex basis-1/2">
          ...
          >
            ...
            >
              ...
              <button
                type="submit"
                className="mt-5 rounded-lg bg-lighter px-20 py-3 transition duration-500 hover:text-white shadow-md"
              >
                SUBMIT
              </button>
            </form>
          ...
          {/* RIGHT SIDE */}
          <motion.div
              className="mt-16 basis-1/2 md:mt-0 md:mx-5 bg-lighter border-2 border-steel border-opacity-40 shadow-sm p-10 rounded-xl"
              initial="hidden"
            whileInView="visible"
            viewport={{ once: true, amount: 0.5 }}
